...
namespace Akeeba\Plugin\Sociallogin\Facebook\Integration;
...
abstract class AbstractFacebookObject
{
	 ...
	 */
	public function __construct($options = [], $client = null, $oauth = null)
	{
	 ...
	 * @throws \Exception
	 */
	public function createConnection($object, $connection = null, $parameters = null, array $headers = [])
	{
	...
	public function getConnection($object, $connection = null, $extra_fields = '', $limit = 0, $offset = 0, $until = null, $since = null)
	{
		...
		// Send the request.
		return $this->sendRequest($path, '', [], $limit, $offset, $until, $since);
	}
	 ...
	 */
	public function sendRequest($path, $data = '', array $headers = [], $limit = 0, $offset = 0, $until = null, $since = null)
	{
		// Send the request.
