...
<a class="akeeba-sociallogin-button akeeba-sociallogin-button-<?= $slug ?>--image hasTooltip"
   ...
   href="<?= $link ?>" title="<?= $tooltip ?>">
	<img
			srcset="https://appleid.cdn-apple.com/appleid/button?scale=6 6x, https://appleid.cdn-apple.com/appleid/button?scale=4 4x, https://appleid.cdn-apple.com/appleid/button?scale=3 3x, https://appleid.cdn-apple.com/appleid/button?scale=2 2x, https://appleid.cdn-apple.com/appleid/button 1x"
